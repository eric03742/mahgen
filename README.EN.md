...
![kokushi muso](doc/images/kokushimusou.png)

![churen poto](doc/images/churenpoto.png)

* Chii

![Chii](doc/images/chi.png)

* Pon

![Pon](doc/images/pong.png)

* Kan

![Kan](doc/images/kan.png)

* Red Dora

![Red Dora](doc/images/red.png)

You can visit [this website](https://eric200203.github.io/frap-book-zh)  to generate your own tile images online ans save them locally for other uses. For example, the tile images shown above were all generated by the site.

---

## Installation

Just use `npm` and execute:
...
The following function is the only API of `mahgen`:
